        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown <?php if($page=='allstudents') echo 'active'?>">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="index.php?page=trainingatthemoment">Students in Training at the moment</a>
...
elseif($page=='supervisors') include('php/supervisors2.php');
...
elseif($page=='allstudents_original') include('php/allstudents_original.php');
      ...
      elseif($page=='supervisors2') include('php/supervisors2.php');
      			elseif($page=='newSupervisor') include('php/newSupervisor2.php');
