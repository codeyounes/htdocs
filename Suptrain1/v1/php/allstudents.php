...
<div class="text-center">
	...
	<p><a href="index.php?page=newStudent">Add New student</a></p>
	<?php if(isset($_SESSION['insNewMsg'])){ echo $_SESSION['insNewMsg'];$_SESSION['insNewMsg']="";}
	$_SESSION['insNewMsg']="";
	?>
...
<table class="table table-striped">
    ...
    <tbody>
	  ...
	  while($row=$result->fetch_assoc()){
		  ...
		  echo '<td><a href="php/deletestudent.php?id='.$row['studentID'].'">Delete</a></td>';
