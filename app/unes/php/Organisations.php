...
<div class="text-center">
	...
	<?php
	if(isset($_SESSION['insNewMsg'])){ echo $_SESSION['insNewMsg'];$_SESSION['insNewMsg']="";}?>
     ...
     <tbody>
		...
		while($row=$result->fetch_assoc()){
		  ...
		  echo '<td>'.$row['email'].'</td>';
		   ...
		   echo '<td><a href="index.php?page=organizationinfo&id='.$row['organizationID'].'">Info</a></td>';
		  echo '<td><a href="index.php?page=deleteorganization&id='.$row['organizationID'].'">Delete</a></td>';
